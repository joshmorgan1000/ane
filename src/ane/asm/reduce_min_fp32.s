...
.Lloop:
    ...
    fmin    z8.s, p0/m, z8.s, z0.s
    fmin    z9.s, p0/m, z9.s, z1.s
    fmin    z10.s, p0/m, z10.s, z2.s
    fmin    z11.s, p0/m, z11.s, z3.s
    incw    x8, all, mul #4
    cmp     x8, x20
    b.lt    .Lloop
...
.Lreduce:
    ...
    fmin    z8.s, p0/m, z8.s, z9.s
    fmin    z10.s, p0/m, z10.s, z11.s
    fmin    z8.s, p0/m, z8.s, z10.s
    fminv   s0, p0, z8.s
    str     s0, [sp, #96]
