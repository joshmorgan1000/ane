// shr_u32.s — Element-wise logical right shift via SME2 streaming SVE
//
// void shr_u32(const uint32_t *input, uint32_t *output, int shift, long n)
//
// Computes output[i] = input[i] >> shift (logical) for i in [0, n).
...
.Lloop:
    ...
    lsr     z0.s, p0/m, z0.s, z8.s
    lsr     z1.s, p0/m, z1.s, z8.s
    lsr     z2.s, p0/m, z2.s, z8.s
    lsr     z3.s, p0/m, z3.s, z8.s
