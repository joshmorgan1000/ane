/** --------------------------------------------------------------------------------------------------------- cblas_bench.c
 * @file cblas_bench.c
 * @brief A simple benchmark for CBLAS SGEMM and DGEMM using the Accelerate framework on Apple Silicon.
 * 
...
/** --------------------------------------------------------------------------------------------------------- main
 * @brief Main function
 * The benchmark runs matrix multiplications for various sizes in order to measure the performance of CBLAS
 * SGEMM and DGEMM on Apple Silicon.
 */
int main() {
